# MAS CLI - Windows & Office Activation Tool
# Based on https://massgrave.dev
# Repository: https://github.com/rcwpt/mas-cli

if (-not $args) {
    Write-Host ''
    Write-Host 'Need help? Check our homepage: ' -NoNewline
    Write-Host 'https://rcwpt.github.io/mas-cli' -ForegroundColor Green
    Write-Host ''
}

& {
    $psv = (Get-Host).Version.Major
    $troubleshoot = 'https://rcwpt.github.io/mas-cli'
